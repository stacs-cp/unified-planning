(define (problem rush-hour-pp)
    ...
    (:objects
        ...
        red car1 car2 car3 car4 car5 car6 car7 car8 car9 car10 car11 car12 - car
    )
    (:init
        (= (total-cost) 0)
        ...
        (containsCar loc2_4 car4)
        (containsCar loc2_5 car5)
        (containsCar loc3_5 car5)
        (containsCar loc2_6 car6)
        (containsCar loc3_6 car6)
        (containsCar loc4_6 car6)
        (containsCar loc3_3 car7)
        (containsCar loc4_3 car7)
        (containsCar loc4_1 car8)
        (containsCar loc4_2 car8)
        (containsCar loc4_4 car9)
        (containsCar loc4_5 car9)
        (containsCar loc5_2 car10)
        (containsCar loc5_3 car10)
        (containsCar loc5_4 car11)
        (containsCar loc6_4 car11)
