(define (problem rush-hour-pp)
    ...
    (:init
        ...
        (containsCar loc3_4 red)
        (containsCar loc1_1 car1)
        (containsCar loc1_2 car1)
        (containsCar loc1_4 car2)
        (containsCar loc2_4 car2)
        (containsCar loc2_1 car3)
        (containsCar loc3_1 car3)
        (containsCar loc4_1 car3)
        (containsCar loc2_5 car4)
        (containsCar loc2_6 car4)
        (containsCar loc3_2 car5)
        (containsCar loc4_2 car5)
        (containsCar loc3_5 car6)
        (containsCar loc4_5 car6)
        (containsCar loc5_5 car6)
        (containsCar loc3_6 car7)
        (containsCar loc4_6 car7)
        (containsCar loc4_3 car8)
        (containsCar loc4_4 car8)
        (containsCar loc5_1 car9)
        (containsCar loc5_2 car9)
