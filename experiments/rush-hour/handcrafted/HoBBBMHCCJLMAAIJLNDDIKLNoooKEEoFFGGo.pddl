(define (problem rush-hour-pp)
    ...
    (:init
        ...
        (containsCar loc3_1 red)
        (containsCar loc3_2 red)
        (containsCar loc1_1 car1)
        (containsCar loc2_1 car1)
        (containsCar loc1_3 car2)
        (containsCar loc1_4 car2)
        (containsCar loc1_5 car2)
        (containsCar loc1_6 car3)
        (containsCar loc2_6 car3)
        (containsCar loc2_2 car4)
        (containsCar loc2_3 car4)
        (containsCar loc2_4 car5)
        (containsCar loc3_4 car5)
        (containsCar loc2_5 car6)
        (containsCar loc3_5 car6)
        (containsCar loc4_5 car6)
        (containsCar loc3_3 car7)
        (containsCar loc4_3 car7)
        (containsCar loc3_6 car8)
        (containsCar loc4_6 car8)
        (containsCar loc4_1 car9)
        (containsCar loc4_2 car9)
        (containsCar loc4_4 car10)
        (containsCar loc5_4 car10)
