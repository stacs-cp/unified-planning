(define (problem rush-hour-pp)
    ...
    (:objects
        ...
        red car1 car2 car3 car4 car5 car6 car7 car8 car9 car10 car11 car12 car13 - car
    )
    (:init
        (= (total-cost) 0)
        ...
        (containsCar loc2_1 car1)
        (containsCar loc1_2 car2)
        (containsCar loc2_2 car2)
        (containsCar loc1_3 car3)
        (containsCar loc1_4 car3)
        (containsCar loc1_5 car4)
        (containsCar loc2_5 car4)
        (containsCar loc1_6 car5)
        (containsCar loc2_6 car5)
        (containsCar loc2_3 car6)
        (containsCar loc2_4 car6)
        (containsCar loc3_1 car7)
        (containsCar loc4_1 car7)
        (containsCar loc5_1 car7)
        (containsCar loc3_4 car8)
        (containsCar loc4_4 car8)
        (containsCar loc3_6 car9)
        (containsCar loc4_6 car9)
        (containsCar loc4_3 car10)
        (containsCar loc5_3 car10)
        (containsCar loc5_4 car11)
        (containsCar loc5_5 car11)
        (containsCar loc5_6 car11)
        (containsCar loc6_1 car12)
        (containsCar loc6_2 car12)
        (containsCar loc6_3 car13)
        (containsCar loc6_4 car13)
        (containsCar loc6_5 car13)
