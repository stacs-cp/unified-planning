; generated by prob2pddl.py 10x12-ps1-e17.prob
; ##########
; #        #
; #  CYP   #
; #  G#B   #
...
; #   ###  #
; ##########
; G:4 P:4 B:3 R:2 O:2 Y:2 C:2 blocks:19 spaces:45
(define (problem puzznic40)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_5_3 orange)
        (patterned loc_7_3 red)
        (patterned loc_5_4 blue)
        (patterned loc_6_4 pink)
        (patterned loc_7_4 blue)
        (patterned loc_2_6 coal)
        (patterned loc_4_6 green)
        (patterned loc_7_6 red)
        (patterned loc_9_6 green)
        (patterned loc_2_7 yellow)
        (patterned loc_4_7 orange)
        (patterned loc_7_7 pink)
        (patterned loc_8_7 green)
        (patterned loc_9_7 pink)
        (patterned loc_4_9 green)
        (patterned loc_6_9 blue)
        (patterned loc_4_10 coal)
        (patterned loc_5_10 yellow)
        (patterned loc_6_10 pink)
    )
