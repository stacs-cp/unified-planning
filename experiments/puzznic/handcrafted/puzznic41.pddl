; generated by prob2pddl.py 10x12-ps1-e21.prob
; ##########
; #        #
; #     C  #
; #     R  #
...
; ##########
; 
; FD found a 52 step plan (including explosions) in 1004s.
; R:4 L:4 Y:2 G:2 B:2 P:2 C:2 blocks:18 spaces:56
(define (problem puzznic41)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_8_2 lightblue)
        (patterned loc_9_2 blue)
        (patterned loc_3_3 lightblue)
        (patterned loc_7_3 red)
        (patterned loc_8_3 pink)
        (patterned loc_9_3 lightblue)
        (patterned loc_7_4 yellow)
        (patterned loc_8_4 lightblue)
        (patterned loc_9_4 blue)
        (patterned loc_7_5 green)
        (patterned loc_8_5 red)
        (patterned loc_7_6 yellow)
        (patterned loc_7_7 green)
        (patterned loc_7_8 coal)
        (patterned loc_7_9 red)
        (patterned loc_7_10 coal)
    )
