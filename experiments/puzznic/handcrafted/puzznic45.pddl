; generated by prob2pddl.py 10x12-ps1-e45.prob
;  ######## 
; #YL      #
; ###Y     #
; ####     #
...
; # GLCB ###
;  ######## 
; G:3 L:3 R:2 Y:2 B:2 P:2 C:2 blocks:16 spaces:51
(define (problem puzznic45)
(:domain puzznic)
