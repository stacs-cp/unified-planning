; generated by prob2pddl.py 8x12-ps1-e47.prob
; ########
; ##    ##
; #  G   #
; #G L O #
...
; #CYCLCO#
; ########
; Y:8 G:8 C:8 O:7 L:6 blocks:37 spaces:21
(define (problem puzznic19)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_4_2 coal)
        (patterned loc_5_2 lightblue)
        (patterned loc_6_2 coal)
