...
class IntegersRemover(engines.engine.Engine, CompilerMixin):
    ...
    def _transform_arithmetic_assignment(
        ...
        for v in range(lb, ub + 1):
            ...
            print(f"\n=== FORMULA COMPARISON ===")
            print(f"Original DNF clauses: {len(result)}")

            # Count clauses in compressed formula
            if compressed_formula.is_or():
                print(f"Compressed clauses: {len(compressed_formula.args)}")
            else:
                print(f"Compressed clauses: 1")
    ...
    def _apply_sliced_table_constraints(self, solutions):
        for solution in solutions:
            print(solution)
    ...
    class IntegersRemover(engines.engine.Engine, CompilerMixin):
        ...
        def _compress_solutions_mfi(
            ...
            return self._entries_to_formula(new_problem, variables, entries, default_tuples)
        ...
        def _transform_action_integers(
            ...
            for effect in old_action.effects:
                ...
                if temp_effect.is_increase() or temp_effect.is_decrease():
                    ...
                    for new_effect in self._transform_arithmetic_assignment(temp_effect, problem, new_problem,
    ...
    def _compress_solutions_mfi(
        ...
        print("default_tuples", default_tuples)
