; generated by prob2pddl.py 9x12-ps1-c17.prob
; #########
; #PG     #
;  #B     #
;   #PB   #
...
;    #G R #
;    ######
; B:3 R:2 G:2 P:2 blocks:9 spaces:61
(define (problem puzznic23)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_4_9 pink)
        (patterned loc_5_9 blue)
        (patterned loc_3_10 blue)
        (patterned loc_2_11 pink)
