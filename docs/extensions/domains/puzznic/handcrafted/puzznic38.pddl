; generated by prob2pddl.py 10x12-ps1-d27.prob
; ##########
; #RB R    #
; #BR P    #
; #######  #
...
; ##BPBPBP##
; ##########
; B:11 P:10 R:3 blocks:24 spaces:30
(define (problem puzznic38)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_9_3 pink)
        (patterned loc_3_4 blue)
        (patterned loc_8_4 pink)
        (patterned loc_7_7 pink)
        (patterned loc_8_7 blue)
        (patterned loc_2_10 blue)
        (patterned loc_3_10 red)
        (patterned loc_5_10 pink)
        (patterned loc_2_11 red)
