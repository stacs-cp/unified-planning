; generated by prob2pddl.py 8x11-ps1-e11.prob
; ####### 
; #R#B#R# 
; #P#P#P# 
; #R B B# 
...
;    # #  
;     #   
; P:5 R:3 B:3 blocks:11 spaces:41
(define (problem puzznic17)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_2_8 red)
        (patterned loc_4_8 blue)
        (patterned loc_6_8 blue)
        (patterned loc_2_9 pink)
        (patterned loc_4_9 pink)
        (patterned loc_6_9 pink)
        (patterned loc_2_10 red)
        (patterned loc_4_10 blue)
        (patterned loc_6_10 red)
    )
