; generated by prob2pddl.py 8x8-ps1-e35.prob
;    ##   
;   #CB#  
;  #BGLP# 
; # GCRL #
...
;    ##   
; 
; Modification of PS1 E-3-5 with moving block static, should be unsolvable.
; G:4 P:4 R:3 B:3 C:2 L:2 blocks:18 spaces:27
(define (problem puzznic16)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_4_7 coal)
        (patterned loc_5_7 blue)
    )
