; generated by prob2pddl.py 10x7-ps1-d34.prob
; ##########
; #       Y#
; #      YP#
; #   L  PR#
...
; #GL CBPBR#
; ##########
; G:4 P:4 Y:3 R:2 B:2 C:2 L:2 blocks:19 spaces:21
(define (problem puzznic27)
(:domain puzznic)
