; generated by prob2pddl.py 10x12-ps1-e28.prob
; #####     
; #   #     
; #   #     
; #   #     
...
; #C  P RG #
; ##########
; R:4 G:4 P:3 B:2 C:2 L:2 blocks:17 spaces:55
(define (problem puzznic43)
(:domain puzznic)
    ...
    (:init
        ...
        (next loc_9_9 loc_10_9 right)
        (next loc_9_9 loc_9_10 up)
        (next loc_10_9 loc_9_9 left)
        (next loc_10_9 loc_10_10 up)
        ...
        (next loc_9_10 loc_10_10 right)
        (next loc_9_10 loc_9_11 up)
        (next loc_9_10 loc_9_9 down)
        (next loc_10_10 loc_9_10 left)
        (next loc_10_10 loc_10_11 up)
        (next loc_10_10 loc_10_9 down)
        ...
        (next loc_10_11 loc_10_10 down)
        (next loc_6_12 loc_7_12 right)
        (next loc_6_12 loc_6_11 down)
        (next loc_7_12 loc_6_12 left)
        (next loc_7_12 loc_8_12 right)
        (next loc_7_12 loc_7_11 down)
        (next loc_8_12 loc_7_12 left)
        (next loc_8_12 loc_9_12 right)
        (next loc_8_12 loc_8_11 down)
        (next loc_9_12 loc_8_12 left)
        (next loc_9_12 loc_10_12 right)
        (next loc_9_12 loc_9_11 down)
        (next loc_10_12 loc_9_12 left)
        (next loc_10_12 loc_10_11 down)
        (patterned loc_2_2 coal)
        (patterned loc_5_2 pink)
        (patterned loc_7_2 red)
        (patterned loc_8_2 green)
        (patterned loc_2_3 green)
        (patterned loc_7_3 green)
        (patterned loc_8_3 red)
        (patterned loc_2_4 lightblue)
        (patterned loc_5_4 pink)
        (patterned loc_2_5 red)
        (patterned loc_3_6 green)
        (patterned loc_4_6 red)
        (patterned loc_5_6 blue)
        (patterned loc_3_7 coal)
        (patterned loc_4_7 lightblue)
        (patterned loc_5_7 pink)
