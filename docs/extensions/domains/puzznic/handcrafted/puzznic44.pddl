; generated by prob2pddl.py 10x12-ps1-e31.prob
; ##########
; # BCR GL #
; # ### #B #
; # BLB ## #
...
; #P P   #  
; ########  
; B:8 R:6 P:4 O:3 L:3 Y:2 G:2 C:2 blocks:30 spaces:30
(define (problem puzznic44)
(:domain puzznic)
    ...
    (:init
        ...
        (patterned loc_3_4 orange)
        (patterned loc_4_4 pink)
        (patterned loc_5_4 red)
        (patterned loc_9_4 coal)
        (patterned loc_2_5 blue)
        (patterned loc_3_5 red)
        (patterned loc_4_5 orange)
        (patterned loc_9_5 blue)
        (patterned loc_3_6 blue)
        (patterned loc_4_6 yellow)
        (patterned loc_5_6 lightblue)
        (patterned loc_6_6 yellow)
        (patterned loc_3_7 red)
        (patterned loc_5_7 orange)
        (patterned loc_6_7 red)
        (patterned loc_6_8 green)
        (patterned loc_3_9 blue)
        (patterned loc_4_9 lightblue)
        (patterned loc_5_9 blue)
        (patterned loc_8_10 blue)
        (patterned loc_3_11 blue)
        (patterned loc_4_11 coal)
        (patterned loc_5_11 red)
        (patterned loc_7_11 green)
        (patterned loc_8_11 lightblue)
    )
