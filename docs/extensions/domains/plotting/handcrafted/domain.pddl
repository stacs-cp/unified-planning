(define (domain plotting)
    ...
    (:predicates
        (hand ?c - colour)
        (coloured ?r ?col - number ?c - colour)
    ...
    (:action shoot-partial-row
        ...
        :effect
            (and
                ...
                (forall (?currentrow ?nextrow ?currentcol - number ?currentcolor ?nextcolor - colour)
                    (and
    ...
    (:action shoot-column
        ...
        :precondition
            (and
                ...
                (or
                    ...
                    (isbottomrow ?t))
                ;; t has to be on top of the bottomrow - added
                (exists (?row - number)
                    (and
                        (isbottomrow ?row)
                        (or (lt ?t ?row) (= ?t ?row))))
        ...
        :effect
            (and
                (forall (?runningrow - number ?nextcolour - colour)
                    (and
    ...
    (:action shoot-row-and-column
            ...
            :effect
                (and
                    ...
                    (forall (?currentrow ?currentcol ?nextrow - number ?currentcolor ?nextcolor - colour)
                        (and
                    ...
                    (forall (?currentrow ?nextrow ?lastcolumn ?lastrow ?d ?dplus1 ?d2 - number ?nextcolour ?currentcolour - colour)
                        (and
                            ...
                            (when
                                (and
                                    ;; comprovar que no surt del rang - added
                                    (isbottomrow ?lastrow)
                                    (or (lt ?nextrow ?lastrow) (= ?nextrow ?lastrow))
                                    ;; we consider the case of the last column
                                    (islastcolumn ?lastcolumn)
                                    ;; distance between the row we shoot at and where we stop is ?d
                                    (distance ?r ?t ?d)
                                    ...
                                    ;; we are on top of the ?t
                                    (or (lt ?nextrow ?t) (= ?nextrow ?t))
                                    ;; nextrow ha de ser major que currentrow?!!! - added
                                    (gt ?nextrow ?currentrow)
                                    ;; and the distance is ?dplus1
                                    (distance ?nextrow ?currentrow ?dplus1)
                                    ;; and the colours are correct and different - does it matter?
                        ...
                        (and
                            (when
                                (and
                                    ...
                                    (succ ?nextrow ?t)
                                    ;; comprovar que no es la ultima! (existeix un succ...) - added
                                    (not (isbottomrow ?t))
